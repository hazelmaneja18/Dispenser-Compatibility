const BASE_55_02_10_DATA = {
  version: "Base 55.02.10",
  ...
  brands: {
    ...
    "Gilbarco": {
      generalNote: "See https://www.vfne.co/verifone-petro-emv-updates for Outdoor EMV Implementation Status updates. When connecting the Verifone Commander Site Controller Ethernet cable to a DCR Serial Converter for Outdoor EMV, the wires routed from the converter to the DCR must be twisted pair.",
    ...
    "Dresser/Wayne": {
      ...
      dispenserSoftwareNotes: [
        ...
        "The dispenser must be programmed as one of the following types: Type 1, 2, 30 or 40. Verifone Commander Site Controller will not support the dispenser programmed as any other type, including Types 3 through 29."
      ],
      dispenserSoftware: [
