const BASE_54_02_05_DATA = {
  version: "54.02.05",
  // Documentation Note: Base 54.02.05 introduces a consolidated reference table 
  // titled "MSD Contactless No Longer Supported by Release" covering distributions: 
  // Buypass, Chase, Chevron, HPS, NBS, Phillips 66, Shell, VAPS, Verifone EPS (LAC), WorldPay.
  // Hardware/firmware compatibility data remains identical to 54.02.04.
  brands: {
    "Bennett": {
